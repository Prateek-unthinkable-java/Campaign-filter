...
//    public List<Campaign> findCampaigns(Campaign campaign);
    ...
    @Query(value = "SELECT c FROM Campaign c WHERE c.campaignId=:campaignId or (c.campaignName=:campaignName ) or " +
            "(c.campaignStatus in :campaignStatus) or (c.createdDate=:createdDate) or " +
